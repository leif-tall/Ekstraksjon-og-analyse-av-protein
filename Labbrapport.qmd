...
![*Resultatene fra homogeniseringen, som viser signalstyrke for protein. C4 - C6 = prøvene til forsøkspersonen (N = 1).*](innsamlet-data/bilder/figur3_resultat_homogenisering.png){#fig-figur3}
...
dt %>% 
  summarise(A = sd(Kontroll_A)/mean(Kontroll_A)*100, 
            ...
            E = sd(Kontroll_D)/mean(Kontroll_D)*100,
            D = sd(Kontroll_E)/mean(Kontroll_E)*100, 
